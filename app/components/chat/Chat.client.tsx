...
import { description, useChatHistory } from '~/lib/persistence/useChatHistory';
  ...
  ({ description, initialMessages, storeMessageHistory, importChat, exportChat }: ChatProps) => {
    ...
    const { messages, status, sendMessage, setMessages, regenerate, error, stop } = useChat({
      ...
      onFinish: ({ message, isAbort, isError }) => {
        // AI SDK v5 - onFinish callback signature changed
        if (message && !isAbort && !isError) {
    ...
    // AI SDK v5 - Derived loading state
    const isLoading = status === 'streaming';

    // AI SDK v5 - Manual input change handler
